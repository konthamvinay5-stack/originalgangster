...
//       <p className="text-slate-600 mt-2">Add some great outfits from our catalog.</p>
...
//                   <button onClick={()=> updateQty(item.id, item.qty - 1)} className="p-2 rounded hover:bg-slate-100"><Minus size={14} /></button>
...
//               <div className="flex-1">
//                 <div className="font-semibold">{item.name}</div>
//                 <div className="text-xs text-slate-500 mt-0.5">Size: <span className="font-medium text-slate-700">{item.size || "—"}</span></div>
//                 <div className="text-sm text-slate-500">{formatINR(item.price)}</div>
//                 <div className="mt-3 flex items-center gap-2">
...
//         <div className="bg-white rounded-2xl p-6 shadow flex flex-col">
//           <div className="text-sm text-slate-500">Order summary</div>
//           <div className="mt-4 text-2xl font-bold">{formatINR(total)}</div>
//           <ul className="text-sm text-slate-600 mt-2 space-y-1">
//             <li className="flex justify-between"><span>Shipping</span><span>Calculated at checkout</span></li>
//             <li className="flex justify-between"><span>Taxes</span><span>Included</span></li>
//           </ul>
//           <div className="mt-6">
//             <button onClick={()=> nav('/checkout')} className="w-full px-4 py-3 rounded-2xl bg-accent text-white font-semibold">Proceed to checkout</button>
//           </div>
//           <Link to="/products" className="text-sm text-slate-600 hover:text-slate-900 mt-3 text-center">Continue shopping</Link>
//         </div>
//       </div>
//     </motion.div>
//   );
